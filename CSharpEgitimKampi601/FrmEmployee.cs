...
namespace CSharpEgitimKampi601
{
    public partial class FrmEmployee : Form
    {
        ...
        string connectionString = "Server=localhost;port=5432;Database=CustomerDb;userId=postgres;password=16";
        void EmployeeList()
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            var connection = new NpgsqlConnection(connectionString);
            connection.Open();
            string query = "İnsert into Employees (EmployeeeName,EmployeeSurname,EmployeeSalary,DepartmenId9 values (@employeeName,@employeeSurname,@employeeSalary,@departmenId";
            var command = new NpgsqlCommand(query, connection);
